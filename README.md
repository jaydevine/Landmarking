...
This repository contains a) Python/Bash scripts for atlas construction and pairwise volumetric image registration, b) Procrustes landmark coordinate data for training and testing (with a sample .dta file), a Julia script to implement the DNN, and a basic R script to project newly acquired shape data into your training space for optimization.  
